...
# Sessions
# En Django 6 `PickleSerializer` fue eliminado por motivos de seguridad.
# Usamos `JSONSerializer`, que es el serializador soportado y recomendado.
SESSION_SERIALIZER = 'django.contrib.sessions.serializers.JSONSerializer'

# Nombre de la cookie de sesión (identificador técnico en minúsculas, sin espacios).
SESSION_COOKIE_NAME = 'facturasapp'
