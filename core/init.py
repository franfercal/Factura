...
dashboard = Dashboard()
# Nombre comercial mostrado en la barra de navegación / marca del sistema.
dashboard.name = 'FACTURASAPP'
...
company = Company()
# Razón social por defecto en datos de empresa (seed inicial).
company.name = 'FACTURASAPP S.A.'
...
module.description = 'Permite administrar las respaldos de base de datos'
module.save()
...
user = User()
user.names = 'Administrador del Sistema'
user.username = 'admin'
